...
MAJ_VER="$(echo "$ACTIVEMQ_ARTEMIS_VERSION" | awk -F"[.]" ' /[0..9]+/ {print $1}' -)"
SUB_VER="$(echo "$ACTIVEMQ_ARTEMIS_VERSION" | awk -F"[.]" ' /[0..9]+/ {print $2}' -)"
#MIN_VER="$(echo "$ACTIVEMQ_ARTEMIS_VERSION" | awk -F"[.]" ' /[0..9]+/ {print $3}' -)"
